...
public class Stmt3Test {
    ...
    public void test1() throws Exception {
        int c = perform("src/test/src5/1", 3, 3);
        assertEquals(1, c);
    }

    @Test
    public void test2() throws Exception {
        int c = perform("src/test/src5/2", 1, 5);
        assertEquals(1, c);
    }

    @Test
    public void test3() throws Exception {
        int c = perform("src/test/src5/3", 1, 5);
        assertEquals(1, c);
    }

    @Test
    public void test4() throws Exception {
        int c = perform("src/test/src5/4", 1, 3);
        assertEquals(1, c);
    }
}
