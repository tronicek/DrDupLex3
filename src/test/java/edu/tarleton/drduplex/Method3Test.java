...
public class Method3Test {
    ...
    private int perform(String srcDir, int maxDistance, int minSize) throws Exception {
        Properties conf = new Properties();
        conf.setProperty("type", "3");
        conf.setProperty("maxDistance", Integer.toString(maxDistance));
        conf.setProperty("minSize", Integer.toString(minSize));
    ...
    public void test1() throws Exception {
        int c = perform("src/test/src4/1", 2, 6);
        assertEquals(1, c);
    }

    @Test
    public void test2() throws Exception {
        int c = perform("src/test/src4/2", 2, 6);
        assertEquals(1, c);
    }

    @Test
    public void test3() throws Exception {
        int c = perform("src/test/src4/3", 1, 3);
        assertEquals(1, c);
    }

    @Test
    public void test4() throws Exception {
        int c = perform("src/test/src4/4", 1, 10);
        assertEquals(1, c);
    }

    @Test
    public void test5() throws Exception {
        int c = perform("src/test/src4/5", 1, 3);
        assertEquals(1, c);
    }

    @Test
    public void test6() throws Exception {
        int c = perform("src/test/src4/6", 4, 7);
        assertEquals(1, c);
    }

    @Test
    public void test7() throws Exception {
        int c = perform("src/test/src4/7", 1, 5);
        assertEquals(1, c);
    }

    @Test
    public void test8() throws Exception {
        int c = perform("src/test/src4/8", 2, 5);
        assertEquals(1, c);
    }
}
